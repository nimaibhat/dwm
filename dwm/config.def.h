...
static const char *tagsel[][2][2] = {
		/*      norm                          sel       */
			/*  fg          bg              fg          bg  */
		{ { "#a3be8c", normbgcolor }, { "#a3be8c", normbgcolor } },
		{ { "#5e81ac", normbgcolor }, { "#5e81ac", normbgcolor } },
		{ { "#ebcb8b", normbgcolor }, { "#ebcb8b", normbgcolor } },
		{ { "#bf616a", normbgcolor }, { "#bf616a", normbgcolor } },
		{ { "#d08770", normbgcolor }, { "#d08770", normbgcolor } },
	};
